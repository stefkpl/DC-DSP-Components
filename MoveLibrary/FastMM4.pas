...
begin
  ...
  begin
    ...
    if (Cardinal(LPInsertAfter.LeakAddress) = Cardinal(APNewEntry.LeakAddress))
      ...
      and ((LPInsertAfter.LeakSize = APNewEntry.LeakSize)
        or (not AExactSizeMatch) and (LPInsertAfter.LeakSize < APNewEntry.LeakSize)) then
    begin
      ...
      begin
        ...
        begin
          ...
          if LPInsertAfter.PreviousLeak <> nil then
            ...
            ExpectedMemoryLeaks.FirstFreeSlot := LPInsertAfter.NextLeak;
        end;
        Result := True;
      end;
      exit;
  ...
  begin
    ...
    begin
      ...
      LPNewEntry.NextLeak := nil;
    if LPNewEntry.PreviousLeak = nil then
